        ...
        <>
            ...
            <section className="bg-navy py-20">
                <div className="max-w-4xl mx-auto px-6 md:px-8">
                    ...
                    >
                        <motion.span variants={staggerChild} className="bg-teal text-white text-xs font-semibold rounded-full px-3 py-1 inline-block mb-5">
                            Natural Language to SQL
                        </motion.span>
                        <motion.h1 variants={staggerChild} className="text-white mb-6">DataGaze.ai</motion.h1>
            ...
            <section id="how-it-works" className="bg-offwhite py-20">
                <div className="max-w-7xl mx-auto px-6 md:px-8">
                    ...
                    >
                        <motion.h2 variants={staggerChild} className="text-textdark">How DataGaze Works</motion.h2>
                    </motion.div>
                    <motion.div
            ...
            <section className="bg-navy py-20">
                <div className="max-w-7xl mx-auto px-6 md:px-8">
                    <motion.div
                        ...
                        className="text-center mb-12"
                    >
                        <motion.h2 variants={staggerChild} className="text-white">Why Teams Love DataGaze</motion.h2>
                    </motion.div>
                    <motion.div
            ...
            <section className="bg-offwhite py-20">
                <div className="max-w-7xl mx-auto px-6 md:px-8">
                    <motion.div
                        ...
                        className="text-center mb-12"
                    >
                        <motion.h2 variants={staggerChild} className="text-textdark">Who Will Benefit from DataGaze?</motion.h2>
                    </motion.div>
                    <motion.div
